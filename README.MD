...
- Check whether link redirects to homepage. **(checked)**
...
- Check non-existing user return message when user does not exist. **(checked)**
...
#### Images
- The website logo and favicon was created by the website creator.
